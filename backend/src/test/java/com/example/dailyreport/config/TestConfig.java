 ...
 * 機能:
 * - テスト専用のBean設定
 * - テスト環境でのPasswordEncoder設定
 * - 共通テストユーティリティの提供
 * - モックオブジェクトの設定
 * 
 * 使用方法:
 * - テストクラスで @Import(TestConfig.class) で読み込み
 * - または @SpringBootTest で自動読み込み
 * 
 * 注意事項:
 * - テスト環境でのみ使用されるConfiguration
 * - プロダクション環境では読み込まれない
 * - @TestConfiguration により自動的にテスト環境として認識
 */
@TestConfiguration
@ActiveProfiles("test")
public class TestConfig {
     ...
     * 
     * プロダクション環境と同じBCryptPasswordEncoderを使用するが、
     * テスト用の軽量設定（strength=4）で高速化
     * 
    ...
    public static class TestConstants {
        ...
        public static final String TEST_PASSWORD_ENCODED = "$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2uheWG/igi.";
        
        /** テスト用JWT秘密鍵 */
        public static final String TEST_JWT_SECRET = "testSecretKeyForJunitTestingPurposesOnly123456789";
