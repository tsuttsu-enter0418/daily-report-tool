 ...
 * 
 * 使用場面:
 * - POST /api/auth/login のレスポンスボディ
 * - AuthController での認証成功レスポンス
 * 
 * Lombok注釈:
...
public class LoginResponse {
    ...
    /** JWT認証トークン */
    @Schema(description = "JWT認証トークン", example = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiLnrqHnkIblj6IiLCJpYXQiOjE2MjQ5NzY2MDAsImV4cCI6MTYyNDk4MDIwMH0...", required = true)
    ...
    /** ユーザー役職 */
    @Schema(description = "ユーザー役職", example = "管理者", allowableValues = {"管理者", "上長", "部下"})
    private String role;
