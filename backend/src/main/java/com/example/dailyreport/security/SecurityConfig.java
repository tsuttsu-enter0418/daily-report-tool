 ...
 *
 * <p>
 * 機能: - JWT認証の有効/無効制御 - デバッグモード時の認証スキップ - CORS設定 - エンドポイントアクセス制御
 */
@Configuration
@EnableWebSecurity
public class SecurityConfig {
        ...
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .exceptionHandling(exceptions -> exceptions
                        .authenticationEntryPoint((request, response, authException) -> {
                            ...
                            response.getWriter()
                                    .write("{\"error\":\"Unauthorized\",\"message\":\"認証が必要です\"}");
                        }));
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOriginPatterns(Arrays.asList("http://localhost:3000", // 開発環境
                "http://*", // ALB内部リクエスト
                "https://*" // 本番HTTPS環境
        ));
